        ...
        return (
            <div className="reservation-confirm-form">
                ...
                <form onSubmit={this.handleSubmit} className="reservation-confirm-form-info">
                    ...
                    <input type="text" placeholder="Phone number" value={this.state.phone_number} onChange={this.update('phone_number')} required/>
                    <input type="email" value={currentUser.email} readOnly/>
                    <br />
                    <textarea placeholder="Add a special request (optional)" value={this.state.special_request} onChange={this.update('special_request')}/>
                    <br />
